...
# 非破坏性 API 边界 probe（59 个 GET，验证 422/200、X-Request-ID 与 validation detail）
...
# OpenAPI 参数边界覆盖归属核算（37 obligations，0 unaccounted）
