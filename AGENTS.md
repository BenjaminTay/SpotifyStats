...
- 播放统计规则引擎 Phase C+D（2026-06-12）：
  ...
  - 测试基线：backend full 554 / unit 228 / contract 126；frontend 125；`npm run build`、`sh scripts/phase5_check.sh`、`.venv/bin/pre-commit run --all-files` 通过
