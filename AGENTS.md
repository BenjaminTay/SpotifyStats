...
- 播放统计规则引擎 Phase C+D（2026-06-12）：
  ...
  - 测试基线：backend full 575 / unit 234 / contract 141；frontend 125；`npm run build`、`sh scripts/phase5_check.sh`、`.venv/bin/pre-commit run --all-files`、`.venv/bin/python scripts/api_smoke_probe.py` 通过
