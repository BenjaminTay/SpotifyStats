...
-- L3 song-work -> native album-work attribution.  This is a rebuildable
-- projection: stable manual intent is stored separately by anchor track.
CREATE TABLE IF NOT EXISTS l3_song_album_attributions (
    ...
    target_project_id        INTEGER NOT NULL REFERENCES album_projects(project_id) ON DELETE CASCADE,
    origin_release_project_id INTEGER NOT NULL REFERENCES album_projects(project_id) ON DELETE CASCADE,
