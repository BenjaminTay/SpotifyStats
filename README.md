...
- **AI 洞察** — 自然语言听歌周报/月报/年度叙事 + 自由问答；报告为缓存优先、手动生成，年度叙事默认生成图文音乐年报 artifact，包含故事章节、重点卡片、真实图表数据、个人榜单关系分析和文风/事实校验；问答通过只读 Agent 工具查询播放、个人 Billboard、账号收藏、搜索历史和社区数据，并展示进度、证据、工具轨迹和 Markdown/表格回答
