...
.venv/bin/python scripts/api_smoke_probe.py  # 本地只读 API smoke（91 个 GET + OpenAPI GET 核算）
...
├── scripts/               # 工具脚本（phase5_check.sh, benchmark_api.py, api_smoke_probe.py）
└── requirements.txt
```
