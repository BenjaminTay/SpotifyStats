...
- **年度总结**：Desktop/Compact 八章个人音乐年鉴，整合播放/时长双榜、个人 Billboard 年度赛季、唯一时间线、关系与收听生活、精选纪录、品味迁移和历史参照；进入页面后会优先生成当前年份，并在后台依次预生成其他可用年份，切换页面不会重置等待时间。Phone 暂保留原年度故事，官方 Wrapped 独立不改
