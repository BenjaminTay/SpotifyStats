...
├── scripts/               # 工具脚本（quickstart_smoke.py, phase5_check.sh, fullstack_verification_check.sh, ci_baseline_parity.py, api_smoke_probe.py, api_boundary_probe.py, openapi_operation_audit.py, benchmark_api.py, runtime_resource_probe.py）
└── requirements.txt
```
