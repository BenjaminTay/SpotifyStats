...
DEFAULT_BOUNDARY_CASES: tuple[BoundaryCase, ...] = (
    ...
    BoundaryCase("account_library_invalid_entity", "/api/account/library/shows"),
    BoundaryCase("account_library_page_low", "/api/account/library/tracks", {"page": 0}),
    BoundaryCase("account_library_limit_low", "/api/account/library/tracks", {"limit": 0}),
    BoundaryCase("account_library_limit_high", "/api/account/library/tracks", {"limit": 51}),
    BoundaryCase(
        "account_library_search_too_long",
        "/api/account/library/tracks",
        {"search": LONG_STRING},
    ),
    BoundaryCase(
        "account_library_special_search",
        "/api/account/library/tracks",
        {"search": SPECIAL_SEARCH, "limit": 5},
        expected_statuses=(200,),
        expect_validation_detail=False,
    ...
    BoundaryCase(
        "account_library_invalid_sort_for_entity",
        "/api/account/library/artists",
        {"sort": "recent"},
    ),
    BoundaryCase(
        "account_library_invalid_sort_enum",
        "/api/account/library/tracks",
        {"sort": "popular"},
    ),
