...
DEFAULT_SAFE_GET_CASES: tuple[SmokeCase, ...] = (
    ...
    SmokeCase("home_overview", "/api/home/overview", DEFAULT_BILLBOARD),
    ...
    SmokeCase(
        "yearly_review_v2_empty_records",
        "/api/yearly-review/2099/records",
        {**DEFAULT_BILLBOARD, "page": 1, "page_size": 5},
    ),
