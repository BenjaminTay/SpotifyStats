    ...
    <BrowserRouter>
      <Routes>
        <Route element={<AppLayout />}>
          ...
          <Route path="/billboard/track/:trackId" element={<Suspense fallback={<RouteFallback />}><TrackDetailPage /></Suspense>} />
          <Route path="/billboard/artist/:artistName" element={<Suspense fallback={<RouteFallback />}><ArtistDetailPage /></Suspense>} />
          <Route path="/billboard/album/:albumName" element={<Suspense fallback={<RouteFallback />}><AlbumDetailPage /></Suspense>} />
