...
export function ReignsSection({ data }: Props) {
  return (
    <div>
      ...
      <EntityRecordCard title="月度统治 · Monthly Reign" subtitle="成为自然月播放冠军次数最多的歌曲/专辑/艺人"
      ...
      <EntityRecordCard title="最快里程碑 · Fastest Milestone" subtitle="从首次播放到达到阈值所需天数最短的歌曲/专辑/艺人"
