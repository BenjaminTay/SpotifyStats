...
export const ACCOUNT_CONFIG: Record<string, AccountInfo> = {
  '@chartdata': {
    ...
    avatar_url: '/avatars/chartdata.jpg',
    banner_url: '/banners/chartdata.jpg',
    banner_bg: 'linear-gradient(160deg, #0d1520, #1a2f1a, #0a0f0a)',
  ...
  '@billboardcharts': {
    ...
    avatar_url: '/avatars/billboardcharts.jpg',
    banner_url: '/banners/billboardcharts.jpg',
    banner_bg: 'linear-gradient(170deg, #1a0f05, #2d1a08, #140c04)',
    follower_tier: 'megastar',
  ...
  '@talkofthecharts': {
    ...
    avatar_url: '/avatars/talkofthecharts.jpg',
    banner_url: '/banners/talkofthecharts.jpg',
    banner_bg: 'linear-gradient(160deg, #0a1220, #152238, #0d1520)',
    follower_tier: 'major',
  ...
  '@popcrave': {
    ...
    avatar_url: '/avatars/popcrave.jpg',
    banner_url: '/banners/popcrave.jpg',
    banner_bg: 'linear-gradient(155deg, #1a0a18, #2d0a28, #140820)',
    follower_tier: 'megastar',
  ...
  '@chartstats': {
    ...
    avatar_url: '/avatars/chartstats.jpg',
    banner_url: '/banners/chartstats.jpg',
    banner_bg: 'linear-gradient(160deg, #0f0a22, #1a1240, #0d0a1e)',
    follower_tier: 'major',
  ...
  '@debutwatch': {
    ...
    avatar_url: '/avatars/debutwatch.jpg',
    banner_url: '/banners/debutwatch.jpg',
    banner_bg: 'linear-gradient(170deg, #1a1005, #2d1a05, #1a0e03)',
    follower_tier: 'mid',
  ...
  '@recordwatch': {
    ...
    avatar_url: '/avatars/recordwatch.jpg',
    banner_url: '/banners/recordwatch.jpg',
    banner_bg: 'linear-gradient(165deg, #1a0a0a, #2d1010, #180808)',
    follower_tier: 'mid',
  ...
  '@throwbackcharts': {
    ...
    avatar_url: '/avatars/throwbackcharts.jpg',
    banner_url: '/banners/throwbackcharts.jpg',
    banner_bg: 'linear-gradient(165deg, #1a1410, #2d2218, #1a120c)',
    follower_tier: 'mid',
  ...
  '@spotifystats': {
    ...
    avatar_url: '/avatars/spotifystats.jpg',
    banner_url: '/banners/spotifystats.jpg',
    banner_bg: 'linear-gradient(160deg, #0a1510, #12281a, #0a140e)',
    follower_tier: 'major',
  ...
  '@collectionvault': {
    ...
    avatar_url: '',
    banner_url: '/banners/collectionvault.jpg',
    banner_bg: 'linear-gradient(160deg, #0e1215, #1a2025, #0e1014)',
    follower_tier: 'niche',
