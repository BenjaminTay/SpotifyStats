              ...
              {activeTab === 'overview' && (
                <>
                  ...
                  <div className="mb-8 grid grid-cols-4 gap-x-6 gap-y-5 border-b border-border pb-8">
                    <KpiItem label="入榜曲目数" value={formatNumber(data.info.total_tracks)} />
                    <KpiItem label="最佳单曲峰值" value={`#${data.info.best_peak}`} accent={data.info.best_peak === 1} />
                  ...
                  {data.info.album_chart_no1_weeks > 0 && (
                    <GlassCard className="mb-8 p-5">
                      ...
                      <p className="mt-2 font-serif text-[24px] font-semibold">
                        {data.info.album_chart_no1_weeks} <span className="font-sans text-[13px] font-normal text-muted-foreground">周 #1</span>
                      </p>
                    </GlassCard>
                  )}
                  ...
                  <div className="mb-8">
                    ...
                    <GlassCard className="overflow-hidden p-0">
                      <table className="mx-7 my-0 w-[calc(100%-56px)] border-collapse">
                        ...
                        <tbody>
                          {(() => {
                            const maxPlays = Math.max(...data.album_weekly_history.map((e) => e.play_count), 1)
