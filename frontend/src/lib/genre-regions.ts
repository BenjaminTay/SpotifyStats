...
const GENRE_MAP: Record<string, GenreInfo> = {
  ...
  'southeast asian pop': { language: 'other', region: '东南亚', flag: '🌏' },
  ...
  'indie/alternative': { language: 'english', region: '全球', flag: '🌍' },
  'singer-songwriter': { language: 'english', region: '全球', flag: '🌍' },
  'singer-songwriter/folk': { language: 'english', region: '全球', flag: '🌍' },
  ...
  'rock/alternative': { language: 'english', region: '全球', flag: '🌍' },
  ...
  'hip hop/rap': { language: 'english', region: '美国', flag: '🇺🇸' },
  ...
  'r&b/soul': { language: 'english', region: '美国', flag: '🇺🇸' },
  ...
  'electronic/dance': { language: 'english', region: '全球', flag: '🌍' },
  ...
  'traditional/folk': { language: 'other', region: '全球', flag: '🌍' },
  ...
  'classical/instrumental': { language: 'instrumental', region: '全球', flag: '🎼' },
  ...
  'jazz/blues': { language: 'instrumental', region: '美国', flag: '🇺🇸' },
  ...
  'country/americana': { language: 'english', region: '美国', flag: '🇺🇸' },
  ...
  'afrobeats/afropop': { language: 'other', region: '非洲', flag: '🌍' },
  ...
  'gospel/christian': { language: 'english', region: '全球', flag: '🌍' },
  'holiday': { language: 'other', region: '全球', flag: '🌍' },
  'soundtrack/stage': { language: 'other', region: '全球', flag: '🌍' },
  'children/family': { language: 'other', region: '全球', flag: '🌍' },
  'comedy/spoken': { language: 'other', region: '全球', flag: '🌍' },
  'caribbean': { language: 'other', region: '加勒比', flag: '🌎' },
  'brazilian': { language: 'other', region: '巴西', flag: '🇧🇷' },
