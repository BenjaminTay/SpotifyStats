...
**前端**：pages/（route container，≤192 行）→ features/（billboard/records|number-ones|all-time、music/details 的 header/primitives/skeletons/overview/tracks/albums/career/artist-releases/album-era 子 sections、settings/components、account/collection）→ components/（ui/charts/layout/shared）
